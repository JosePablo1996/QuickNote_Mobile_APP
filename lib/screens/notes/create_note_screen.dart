// lib/screens/notes/create_note_screen.dart
// Pantalla para crear nuevas notas - VERSIÓN SIMPLIFICADA
// ✅ Responsabilidad única: crear notas
...
// ============================================
// PANTALLA PRINCIPAL DE CREACIÓN
// ============================================
...
class _CreateNoteScreenState extends ConsumerState<CreateNoteScreen> {
  ...
  Future<void> _saveNote() async {
    ...
    final created = await ref.read(notesProvider.notifier).createNote(noteData);
    ...
    if (created != null && mounted) {
      ToastMessage.success('Nota creada exitosamente');
      context.go('/notes');
    } else if (mounted) {
      setState(() => _error = 'Error al crear la nota');
      ToastMessage.error('Error al crear la nota');
    }
  }
